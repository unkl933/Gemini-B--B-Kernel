...
OUTPUT_ARCH(arm)
ENTRY(_start)
SEARCH_DIR("=/home/b--b/WORKSPACE/Gemini/builds/aarch64-Mi5-linux-gnu/aarch64-Mi5-linux-gnu/lib"); SEARCH_DIR("=/usr/local/lib"); SEARCH_DIR("=/lib"); SEARCH_DIR("=/usr/lib");
SECTIONS
{
